...
async function getQuotaHandler(request: NextRequest, context?: Record<string, unknown>) {
  ...
  return successResponse({ remainingQuota: user.remainingQuota }, 'Quota retrieved successfully');
}
