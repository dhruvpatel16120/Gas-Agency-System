  ...
  if (booking.paymentMethod !== 'UPI' || booking.paymentStatus !== 'FAILED') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <AlertCircle className="w-12 h-12 mx-auto text-red-500 mb-4" />
          <p className="text-gray-600">This booking is not eligible for repayment</p>
          <Button onClick={() => router.push('/user')} className="mt-4">
            Back to Dashboard
          </Button>
        </div>
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-gray-900">{booking.quantity} cylinder(s)</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Amount:</span>
                    <span className="ml-2 text-gray-900">
                      {booking.paymentAmount ? formatCurrency(booking.paymentAmount) : 'N/A'}
                    </span>
                  </div>
                  <div>
              ...
              <form onSubmit={handleRepay} className="space-y-4">
                <div>
                  <label htmlFor="upiTxnId" className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Please enter the transaction ID from your UPI app after making the payment
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        <li>Make sure you have sufficient balance in your UPI account</li>
                        <li>Complete the payment in your UPI app first</li>
                        <li>Copy the transaction ID exactly as shown in your UPI app</li>
