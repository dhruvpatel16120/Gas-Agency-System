...
type AnalyticsData = {
  ...
  topUsers: Array<{ userId: string; name: string; bookings: number; totalSpent: number }>;
  deliveryPerformance: {
    averageDeliveryTime: number;
...
export default function BookingAnalyticsPage() {
  ...
  }, [session, dateRange, customStartDate, customEndDate]);
  ...
  const exportData = async (format: 'csv' | 'excel' | 'pdf') => {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/bookings/analytics/export?${params.toString()}`);
      if (res.ok) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Comprehensive insights into your booking operations</p>
              </div>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900">{formatNumber(analytics.overview.totalBookings)}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900">{analytics.overview.averageDeliveryTime} days</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                        ...
                        <div key={item.status} className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <div className={`w-3 h-3 rounded-full ${
                              ...
                              item.status === 'OUT_FOR_DELIVERY' ? 'bg-purple-400' :
                    ...
                    <div className="space-y-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-gray-900">
                          {analytics.deliveryPerformance.onTimeDeliveries}/{analytics.deliveryPerformance.totalDeliveries}
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-green-600">
                            {Math.round((analytics.deliveryPerformance.onTimeDeliveries / analytics.deliveryPerformance.totalDeliveries) * 100)}%
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span>Delayed</span>
                          <span className="font-medium text-red-600">
                            {Math.round((analytics.deliveryPerformance.delayedDeliveries / analytics.deliveryPerformance.totalDeliveries) * 100)}%
                          </span>
                        </div>
                      </div>
                    </div>
