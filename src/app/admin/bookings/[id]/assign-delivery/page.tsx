...
import { ArrowLeft, Save, Truck, Package, Calendar, CheckCircle, AlertCircle } from "lucide-react";
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [bookingRes, partnersRes] = await Promise.all([
        ...
        fetch("/api/admin/deliveries/partners?includeStats=true", {
          cache: "no-store",
        }),
      ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/admin/bookings/${bookingId}/assign-delivery`,
        {
          method: "POST",
      ...
      if (res.ok && result.success) {
        toast.success(
          "Delivery partner assigned successfully! Email notification sent to customer.",
        );
          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                ...
                <span className="font-medium">{booking.status}</span> status.
                Delivery can only be assigned to approved bookings.
              </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Select a delivery partner for this booking
              </p>
            </div>
          </div>
                ...
                {partners && partners.length > 0 ? (
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <div className="text-sm font-medium text-gray-900">
                              {partner.currentAssignments || 0}/
                              {partner.capacityPerDay}
                            </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        router.push("/admin/deliveries/partners/new")
                      }
                      className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700"
                    >
                      Add New Partner
