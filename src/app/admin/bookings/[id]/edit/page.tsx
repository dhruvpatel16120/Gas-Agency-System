...
import { ArrowLeft, Save, Package, User, AlertCircle } from "lucide-react";
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          expectedDate: bookingData.expectedDate
            ? new Date(bookingData.expectedDate).toISOString().split("T")[0]
            : "",
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Modify booking details and information
              </p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, status: e.target.value as 'PENDING' | 'APPROVED' | 'OUT_FOR_DELIVERY' | 'DELIVERED' | 'CANCELLED' }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                      required
                    >
