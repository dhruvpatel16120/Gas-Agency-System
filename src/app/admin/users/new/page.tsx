            ...
            >
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    name="name"
                    className="w-full border rounded pl-9 pr-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    name="userId"
                    className="w-full border rounded pl-9 pr-3 py-2 text-gray-900"
