...
import { RefreshCw, Search, Filter, MessageSquare, Inbox, CheckCircle2, Archive, Clock, AlertCircle, Mail, Calendar, Eye } from "lucide-react";
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 flex-1">
                  ...
                  <div className="flex items-center gap-2 text-black">
                    ...
                    <select
                      ...
                      value={state}
                      onChange={(e) => {
                        setState(e.target.value as "ALL" | "NEW" | "OPEN" | "RESOLVED" | "ARCHIVED");
                        setPage(1);
                      }}
                    >
                    ...
                    items.map((contact) => (
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="max-w-xs">
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-500">
                              ...
                              {contact.priority &&
                                priorityConfig[
                                  contact.priority as keyof typeof priorityConfig
                                ] && (
                                  <span
                                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${priorityConfig[contact.priority as keyof typeof priorityConfig].color}`}
                                  >
                                    {
                                      priorityConfig[
                                        contact.priority as keyof typeof priorityConfig
                        ...
                        <td className="px-6 py-4 text-center">
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border ${statusConfig[contact.status].color}`}
                          >
                        ...
                        <td className="px-6 py-4 text-center">
                          ...
                          priorityConfig[
                            ...
                            <span
                              className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${priorityConfig[contact.priority as keyof typeof priorityConfig].color}`}
                            >
                              {
                                priorityConfig[
                                  contact.priority as keyof typeof priorityConfig
